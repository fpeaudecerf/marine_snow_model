...
03.07.2020: modification for modulation of viscosity with temperature
...
omega = 0.26     # exponent in the power law for settling velocity with radius in Alldredge 1988
B     = 4.18e-3  # m^(1-omega) s-1, pre-factor for settling velocity with radius in Alldredge 1988
...
### New part about temperature
T_Alldredge = 15.0 # temperature in Alldredge 1988, in Celsius
S_Alldredge = 33.6/1000 # salinity in Alldredge 1988, in mass fraction
mu_Alldredge = muTS(T_Alldredge,S_Alldredge)

B_prime = B*mu_Alldredge # m^(1-omega) s-1 * kg/(m s)
print('mu Alldredge 15C = ', mu_Alldredge,'; B_prime = ',B_prime)
print('nu Alldredge 15C = ', nuTS(T_Alldredge,S_Alldredge))
